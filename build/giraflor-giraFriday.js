...
var runPromoModal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var currentTime, promoStartTime, promoEndTime;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          currentTime = new Date();
          promoStartTime = new Date("2025-11-11T08:30:00.000000-03:00");
  ...
  return function runPromoModal() {
    return _ref.apply(this, arguments);
  };
}();
var mountElmentBlock = function mountElmentBlock() {
  var hasKeyOnLocalStorage = localStorage.getItem("clubeGira2025Modal");
  ...
  var validatePassword = function validatePassword() {
    if (passwordInput.value.toLowerCase() === "leveza15") {
      ...
      var element = document.querySelector(".giraFriday_overlay");
      setTimeout(function () {
        element.remove();
      }, 500);
    } else {
...
var checkClubeGiraQueryParam = function checkClubeGiraQueryParam() {
  ...
  var clubeGiraParam = urlParams.get("clubeGira2025");
  var hasShowLinkOnLocalStorage = localStorage.getItem("clubeGira2025Link");
  var currentTime = new Date();
  var promoEndTime = new Date("2025-12-14T23:59:00.000000-03:00");
...
var createLinkGira = function createLinkGira() {
  var desktopMenu = document.querySelector(".js-desktop-nav.desktop-nav");
  var mobileMenu = document.querySelector("#nav-hamburger .clear-both ul");
  var buttonGira = document.querySelector('[data-store="home-categories-featured"] ul li [title="Clube Gira"]');
  var hasShowLinkOnLocalStorage = localStorage.getItem("clubeGira2025Link");
  if (hasShowLinkOnLocalStorage !== "true") {
    buttonGira === null || buttonGira === void 0 || buttonGira.remove();
    return;
  }
  if (desktopMenu) {
    var elementDesktop = "<li class=\"desktop-nav-item \">\n\t\t      <a href=\"https://www.aaventurina.com.br/clube-gira\" class=\"desktop-nav-link\">\n          <span class=\"divider-bullet opacity-50 m-right-half\" aria-hidden=\"true\"></span>\n\t\t\t\t\t\tClube Gira\n\t\t      </a>\n\t\t\t</li>";
    var secondChild = desktopMenu.children[1];
    if (secondChild) {
...
"use strict";
/*!*****************************************!*\
  !*** ./styles/giraflor-giraFriday.scss ***!
  \*****************************************/
